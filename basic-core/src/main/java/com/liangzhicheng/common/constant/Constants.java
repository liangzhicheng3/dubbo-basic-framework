...
public abstract class Constants {
     ...
     * 请求参数key
     */
    public static final String REQUEST_PARAM_KEY = "BUqNNQ3ecKUDYofUcEn0I6qDJsMDoi3Mp4yOtTGiZaxqTYFeMUnlPNAqAJ";
    /**
     * 请求参数有效时间(秒)
     */
    public static final Integer REQUEST_PARAM_TIME = 10;
...
//    public static final String UTIL_PDF_PREFIX = "/usr/workspace/project/pdf/"; //线上pdf路径前缀
//    public static final String UTIL_PDF_PATH = "/usr/workspace/project/pdf-util/wkhtmltopdf"; //线上pdf工具路径
//    public static final String UTIL_CONTENT_FILTER_PATH = "/usr/workspace/project/content-filter/censorwords.txt"; //线上敏感词文件路径
     ...
     * APP获取用户信息相关常量
     */
    public static final String WECHAT_APP_OAUTH_URL_USER = "https://api.weixin.qq.com/sns/oauth2/access_token?";
    public static final String WECHAT_APP_URL_INFO_USER = "https://api.weixin.qq.com/sns/userinfo?";
     ...
     */
    public static final String WECHAT_ORDER_URL = "https://api.mch.weixin.qq.com/pay/unifiedorder";
    /**
     * WeChat小程序支付
     */
    ...
    public static final String MINI_NOTIFY_URL = "http://xxx/client/weChatMiniPayNotify"; //异步通知支付结果Url
    /**
     * WeChat APP支付
     */
    ...
    public static final String APP_NOTIFY_URL = "http://xxx/client/weChatAppPayNotify"; //异步通知支付结果Url
    /**
     * WeChat扫码支付
     */
    ...
    public static final String WECHAT_SCAN_URL = "weixin://wxpay/bizpayurl?"; //生成二维码前缀连接
    public static final String WECHAT_SCAN_NOTIFY_URL = "http://xxx/web/weChatScanPayNotify"; //异步通知支付结果Url
    /**
     * WeChat公众号支付
     */
    ...
    public static final String PUB_NOTIFY_URL = "http://xxx/client/weChatPubPayNotify"; //异步通知支付结果Url
    /**
     * WeChat退款
     */
    //退款证书的路径：登录微信商户平台——账户中心——账户设置——API安全——下载证书，java用apiclient_cert.p12这个文件
    public static final String PATH_CERT = "/opt/workspace/cert/apiclient_cert.p12"; //linux
    ...
    //异步通知支付结果Url
    public static final String ALIPAY_APP_NOTIFY_URL = "http://xxx/client/alipayAppPayNotify";
    /**
     * Alipay扫码支付
     */
    ...
    //即时到帐支付成功后的跳转页面
    public static final String ALIPAY_SCAN_RETURN_URL = "http://www.ttocz.com";
    //即时到帐商品展示页面
    public static final String ALIPAY_SCAN_SHOW_URL = "http://www.ttocz.com";
    //调试用，创建TXT日志文件夹路径
    public static final String LOG_PATH = "/usr/workspace/xxx/alipay/";
    //签名方式，不需修改
    public static final String SIGN_TYPE_SCAN = "MD5";
    //异步通知支付结果Url
    public static final String ALIPAY_SCAN_NOTIFY_URL = "http://xxx/web/payWebController/alipayScanPayNotify";
     ...
     * 七牛存储相关常量
     */
    public static final String QINIU_APP_KEY = "BUqNNQ3ecKgA3kEn0I6qDJzYbBG_lFeMUnlPN-eH"; //个人信息->密钥管理
    public static final String QINIU_APP_SECRET = "NaCF0hW0vCqdpLmSioLZwRmPMmwPbAqAJiTLho2F";
