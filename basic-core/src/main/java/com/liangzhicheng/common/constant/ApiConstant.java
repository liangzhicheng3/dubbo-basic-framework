...
public class ApiConstant {
	 ...
	 * 保存成功
	 */
	public static final int PARAM_SAVE_SUCCESS = 10001;
	/**
	 * 失败
	 */
	 ...
	 * 保存失败
	 */
	public static final int PARAM_SAVE_FAIL = 41000;
	/**
	 * 参数不能为空
	 */
	 ...
	 * 未登录
	 */
	public static final int NO_LOGIN = 42001;
	/**
	 * 密码错误
	 */
	public static final int PASSWORD_ERROR = 42002;
	 ...
	 * 记录不存在
	 */
	public static final int LOG_NOT_EXIST = 43004;

    static{
		map.put(BASE_SUCCESS_CODE, "success");
		map.put(PARAM_SAVE_SUCCESS, "保存成功");
